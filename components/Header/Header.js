  ...
  return (
    <header className="flex place-content-center ">
      <div className="container flex flex-col gap-1 lg:flex-row place-content-between bg-gray-100 lg:rounded-lg lg:mx-2 lg:mt-4 items-center dark:bg-gray-900 light:bg-blue">
        <Link href="/" locale={locale} className="relative hover:opacity-70">
        ...
        <div className="flex justify-items-end">
          <Link href="/" locale="en">
            <a className="lg:py-6 lg:px-3 py-2 px-1">
              <Image src="/images/flag-en.png" alt="Picture of the " width={25} height={25} />
            </a>
          </Link>
          <Link href="/" locale="es">
            <a className="lg:py-6 lg:px-3 py-2 px-1">
              <Image src="/images/flag-es.png" alt="Picture of the author" width={25} height={25} />
            </a>
          </Link>
        </div>
      </div>
